...
class EmployeeController extends Controller
{
    ...
    public function create(){
        ...
        // ->join('people_religions','people_religions.people_uuid','=','people.uuid')
        // ->join('religions','religions.uuid','=','people_religions.religion_uuid')
        // ->get([
        //     'people.name',
        //     'religions.religion'
        // ]);
        // $data = DB::table('people')
        // ->where('people_pohs','people_pohs.people_uuid','=','people.uuid')
        // // ->join('religions','religions.uuid','=','people_religions.religion_uuid')
        // ->get([
        //     'people.name',
        //     'people_pohs.uuid as uuid_poh'
        // ]);
        // $store = Brand::create([
        //     'brand' => 'baru'
        // ]);
