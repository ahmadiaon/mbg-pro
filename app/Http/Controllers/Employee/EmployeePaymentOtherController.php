...
class EmployeePaymentOtherController extends Controller
{
        ...
        try{
            ...
            while((int)$sheet->getCell( 'A'.$no_employee)->getValue() != null){
                ...
                $data_employee_payment = [
                    ...
                    'payment_other_total' => $sheet->getCell( 'J'.$no_employee)->getValue(),
    ...
    public function store(Request $request){
        // $data = $request->all();
        $payment_other_uuid = $request->payment_other_date;
        $date = $request->payment_other_date;
        $employee_uuid = $request->employee_uuid;

        if(empty($request->uuid)){
            $request->uuid = 'OP-'.$date.'-'.$payment_other_uuid.'-'.$employee_uuid;
        }
        $strore = EmployeePaymentOther::updateOrCreate(['uuid' => $request->uuid], 
        [
            'employee_uuid' => $request->employee_uuid,
            'payment_other_value' => $request->payment_other_value,
            'payment_other_much' => $request->payment_other_much,
            'payment_other_total' => $request->payment_other_much * $request->payment_other_value,
            'payment_other_date' => $request->payment_other_date,
            'payment_other_uuid' => $request->payment_other_uuid,

            'payment_other_description'    => $request->payment_other_description,
        ]);
