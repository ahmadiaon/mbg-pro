...
<div class="left-side-bar">
    <div class="brand-logo">
        <a href="index.html">
            <img src="{{ env('APP_URL')}}vendors/images/deskapp-logo.svg" alt="" class="dark-logo" />
            <img src="{{ env('APP_URL')}}vendors/images/deskapp-logo-white.svg" alt="" class="light-logo" />
        </a>
    ...
    <div class="menu-block customscroll">
        <div class="sidebar-menu">
            <ul id="accordion-menu">
                <li>
                    <a href="/admin/people" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-calendar4-week"></span><span class="mtext">People</span>
                    </a>
                </li>
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        <li><a href="/admin/employee-contract">Employee</a></li>
                        <li><a href="datatable.html">DataTables</a></li>
                    </ul>
                </li>
                {{-- <li>
                    <a href="/admin/department" class="dropdown-toggle no-arrow">
                        <span class="micon bi bi-calendar4-week"></span><span class="mtext">Database</span>
                    </a>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
