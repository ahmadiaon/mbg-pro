<head>
    ...
    <link
        ...
        sizes="180x180"
        href="{{env('APP_URL')}}vendors/images/apple-touch-icon.png"
    />
    <link
        rel="icon"
        type="image/png"
        sizes="32x32"
        href="{{env('APP_URL')}}vendors/images/favicon-32x32.png"
    />
    <link
        rel="icon"
        type="image/png"
        sizes="16x16"
        href="{{env('APP_URL')}}vendors/images/favicon-16x16.png"
    />
    ...
    <link
        rel="stylesheet"
        type="text/css"
        href="{{env('APP_URL')}}vendors/styles/icon-font.min.css"
    />
    <!-- Slick Slider css -->
