                            ...
                            <div class="pd-20 card-box mb-30">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="name" class="form-control @error('name') is-invalid @enderror"
                                        value="{{ old('name') }}" id="name" placeholder="Ahmadi Alpasyri" type="text">
                                    @error('name')
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="religion_id" class="form-control">
                                                ...
                                                <option value="{{ $religion->id }}" selected>{{ $religion->religion }}
                                                </option>
                                                @else
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <div class="form-group">
                                            ...
                                            <select name="group_license"
                                                class="form-control  @error('group_license') is-invalid @enderror">
                                                <option value="C" {{ (old('group_license')=='C' )?'selected':'' }}>A
                                                </option>
                                                <option value="B-1" {{ (old('group_license')=='B-1' )?'selected':'' }}>
                                                    B-1
                                                </option>
                                                <option value="A" {{ (old('group_license')=='A' )?'selected':'' }}>A
                                                </option>
                                                <option value="B-I Umum" {{ (old('group_license')=='B-I Umum'
                                                    )?'selected':'' }}>B-I Umum</option>
                                                <option value="B-II" {{ (old('group_license')=='B-II' )?'selected':''
                                                    }}>
                                                    B-II</option>
                                                <option value="B-II Umum" {{ (old('group_license')=='B-II Umum'
                                                    )?'selected':'' }}>B-II Umum</option>
                                            </select>
                                            @error('group_license')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                    ...
                                    <div class="col-9">
                                        <div class="form-group">
                                            ...
                                            <input name="license_number"
                                                ...
                                                value="{{ old('license_number') }}" id="license_number"
                                                placeholder="Muara Teweh" type="text">
                                    ...
                                    <div class="col-7">
                                        <div class="form-group">
                                            ...
                                            <input name="poh_place"
                                                ...
                                                value="{{ old('poh_place') }}" id="poh_place" placeholder="Barito Utara"
                                                type="text">
                                            @error('poh_place')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                    ...
                    <div class="pd-20 card-box mb-20">
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="sd_name" class="form-control @error('sd_name') is-invalid @enderror"
                                        value="{{ old('sd_name') }}" id="sd_name" placeholder="Muara Teweh" type="text">
                                    @error('sd_name')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label>Daerah</label>
                                    <input name="sd_place" class="form-control @error('sd_place') is-invalid @enderror"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="sd_year" class="form-control @error('sd_year') is-invalid @enderror"
                                        value="{{ old('sd_year') }}" id="sd_year" placeholder="Muara Teweh" type="text">
                                    @error('sd_year')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                        ...
                        <div class="row">
                            <div class="col-md-5 col-sm-12">
                                <div class="form-group">
                                    <label>Nama Sekolah</label>
                                    <input name="smp_name" class="form-control @error('smp_name') is-invalid @enderror"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    <label>Lulus Tahun</label>
                                    <input name="smp_year" class="form-control @error('smp_year') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label>Nama Sekolah</label>
                                    <input name="sma_name" class="form-control @error('sma_name') is-invalid @enderror"
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Lulus Tahun</label>
                                    <input name="sma_year" class="form-control @error('sma_year') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="ptn_name" class="form-control @error('ptn_name') is-invalid @enderror"
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Lulus Tahun</label>
                                    <input name="ptn_year" class="form-control @error('ptn_year') is-invalid @enderror"
                        ...
                        <div class="row">
                            <div class="col-md-4 col-sm-12">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input name="dll_name" class="form-control @error('dll_name') is-invalid @enderror"
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Lulus Tahun</label>
                                    <input name="dll_year" class="form-control @error('dll_year') is-invalid @enderror"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="exp_1_date_end" value="{{ old('exp_1_date_end') }}" id="exp_1_date_end"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="exp_1_reason"
                                        ...
                                        value="{{ old('exp_1_reason') }}" id="exp_1_reason" placeholder="Muara Teweh"
                                        type="text">
                                    @error('exp_1_reason')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Akhir Kerja</label>
                                    <input name="exp_2_date_end" value="{{ old('exp_2_date_end') }}" id="exp_2_date_end"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="exp_2_reason"
                                        ...
                                        value="{{ old('exp_2_reason') }}" id="exp_2_reason" placeholder="Muara Teweh"
                                        type="text">
                                    @error('exp_2_reason')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Akhir Kerja</label>
                                    <input name="exp_3_date_end" value="{{ old('exp_3_date_end') }}" id="exp_3_date_end"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="exp_3_reason"
                                        ...
                                        value="{{ old('exp_3_reason') }}" id="exp_3_reason" placeholder="Muara Teweh"
                                        type="text">
                                    @error('exp_3_reason')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    <label>Akhir Kerja</label>
                                    <input name="exp_4_date_end" value="{{ old('exp_4_date_end') }}" id="exp_4_date_end"
                            ...
                            <div class="col-md-3 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="exp_4_reason"
                                        ...
                                        value="{{ old('exp_4_reason') }}" id="exp_4_reason" placeholder="Muara Teweh"
                                        type="text">
                                    @error('exp_4_reason')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                        ...
                        <div class="col-md-1 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="year_health"
                                    ...
                                    value="{{ old('year_health') }}" id="year_health" placeholder="2012" type="text">
                                @error('year_health')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                ...
                <div class="pd-20 card-box mb-30">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="department_id" class="custom-select2 form-control">
                                    ...
                                    <option value="{{ $department->id }}" selected>{{ $department->department }}
                                    </option>
                                    @else
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>Jabatan</label>
                                <select name="position_id" class="custom-select2 form-control">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="insentif" class="form-control @error('insentif') is-invalid @enderror"
                                    value="{{ old('insentif') }}" id="insentif" placeholder="Muara Teweh" type="text">
                                @error('insentif')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="premi_bk" class="form-control @error('premi_bk') is-invalid @enderror"
                                    value="{{ old('premi_bk') }}" id="premi_bk" placeholder="Muara Teweh" type="text">
                                @error('premi_bk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="premi_nbk" class="form-control @error('premi_nbk') is-invalid @enderror"
                                    value="{{ old('premi_nbk') }}" id="premi_nbk" placeholder="Muara Teweh" type="text">
                                @error('premi_nbk')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                <label>Kayu</label>
                                <input name="premi_kayu" class="form-control @error('premi_kayu') is-invalid @enderror"
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="premi_mb" class="form-control @error('premi_mb') is-invalid @enderror"
                                    value="{{ old('premi_mb') }}" id="premi_mb" placeholder="Muara Teweh" type="text">
                                @error('premi_mb')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="col-md-3 col-sm-12">
                            <div class="form-group">
                                ...
                                <input name="premi_rj" class="form-control @error('premi_rj') is-invalid @enderror"
                                    value="{{ old('premi_rj') }}" id="premi_rj" placeholder="Muara Teweh" type="text">
                                @error('premi_rj')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
