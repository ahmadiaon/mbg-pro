                    ...
                    <div class="pd-20 card-box">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">{{ $people->address }}</div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">{{ $people->group_poh }}, Di {{ $people->poh_place
                                    }}</div>
                            </div>
                            <hr />
                            <div class="row">
                                ...
                                <div class="col-sm-9 text-secondary">{{ $people->phone_number }}</div>
                            </div>
                            <hr />
                            <div class="row">
                                <div class="col-sm-3">
