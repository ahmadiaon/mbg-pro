...
<body>
    {{-- <div id="kepala_surat">
        <img src="/vendors/images/paten.jpg" width="70px" height="auto" id="logo_surat" valign="baseline" />
    ...
    <div style="padding-left: 30px;">
        ...
        <div style="padding-left: 30px;">
            ...
            <div style="display:inline-block; width: 2px;">: </div>
            <div style="display:inline-block; width: 400px;">{{ $surat->business_name}} </div>
            <br><br>
        </div>
        Dengan mengajukan peminjaman dana  rekening tabungan {{ $surat->financial}}  <br>
        ...
        <div style="padding-left: 30px;">
            <div class="tanda_tangan" style="float:right">
                <div class="kosong" id="pejabat">hormat saya,<br /></div>
