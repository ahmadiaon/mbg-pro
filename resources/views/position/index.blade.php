...
@section('content')
                ...
                <div class="btn-group">  
                    ...
                    <div class="btn-group dropdown">
                        ...
                        <div class="dropdown-menu">
                            <a class="dropdown-item" id="btn-export" href="/database/position/export">Export</a>
    ...
    <div class="modal fade" id="import-modal" tabindex="-1" role="dialog" aria-labelledby="import-modalTitle"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <form id="form-import" action="/database/position/import" method="post" enctype="multipart/form-data">
                @csrf
                <div class="modal-content">
                    <div class="modal-header">
