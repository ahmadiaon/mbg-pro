                    ...
                    <div class="login-box bg-white box-shadow border-radius-10">
                        ...
                        <form action="/web/login" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group custom">
                                <input type="text" name="nik_employee" class="@error('nik_employee') is-invalid @enderror form-control form-control-lg" placeholder="NRP Contoh. MBLE-0422003" />
                                <div class="input-group-append custom">
                                    <span class="input-group-text"><i class="icon-copy dw dw-user1"></i></span>
                                </div>								
                            </div>
                            <div class="input-group custom">
                                <input type="text" class="@error('nik_employee') is-invalid @enderror form-control form-control-lg" name="password" placeholder="NIK KTP Conth, 6212341234567890" />
                                <div class="input-group-append custom">
