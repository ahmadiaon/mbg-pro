        ...
        <div class="pd-20 card-box mb-30">
            ...
            <form action="/community/{{ $community->id }}" method="post" id="main_form">
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <textarea name="description"
                                class="form-control">{{ old('description',$community->description) }}</textarea>
                            @error('description')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="city" type="text"
                                ...
                                value="{{ old('city',$community->city,'Palangka Raya') }}">
                            @error('city')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="province" type="text"
                                ...
                                value="{{ old('province',$community->province,'Kalimantan Tengah') }}">
                            @error('province')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="form-group">
                            ...
                            <input required name="youtube" type="text"
                                ...
                                value="{{ old('youtube',$community->youtube) }}">
                        </div>
                        @error('youtube')
                        <div class="invalid-feedback">
                            {{ $message }}
                ...
                <div class="form-group">
                    ...
                    <select name="gallery" required id="select-meal-type" class="custom-select2 form-control"
                    ...
                    <div class="col-md-12 col-sm-12">
                        <div class="form-group">
                            ...
                            <select name="status" class="form-control">
                                <option value="1" {{ (old("status",$community->status) == "1" ? "selected":"") }}>Ya
                                </option>
                                <option value="0" {{ (old("status",$community->status) == "0" ? "selected":"") }}>Tidak
                                </option>
                            </select>
                        </div>
                    </div>
