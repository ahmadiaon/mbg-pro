...
@section('js')
    <script>
        ...
        function store(idForm){
            if(isRequired(['employee_uuid','payment_other_uuid','payment_other_description','payment_other_value','payment_other_much','payment_other_date'])    > 0){ return false; }
       ...
       function editData(uuid){
        ...
        function reloadTable(year_month) {
            ...
            showDataTableUserPrivilege(_url, ['payment_other_date', 'payment_other_much','payment_other_value','payment_other_total'],
                'table-other-payment')
        }
    </script>
@endsection
