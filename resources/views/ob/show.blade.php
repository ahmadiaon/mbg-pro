        ...
        <div class="modal-content mb-30">
            <div class="modal-header">
                ...
                <div class="alert alert-primary" role="alert">
                    Has done setup
                    <a href="/admin-ob/hour-meter/{{ $over_burden->uuid }}">
                        <button type="button" class="btn btn-primary">
                            HM <span class="icon-copy ti-dashboard"></span>
                        </button>
                    </a>
                    <a href="/admin-ob/ritasi/{{ $over_burden->uuid }}">
            ...
            <form action="/admin-ob" method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    @csrf
                    <input type="hidden" name="uuid" value="{{ $over_burden->uuid }}">
                    <div class="row">
                        {{-- checker --}}
                        <div class="col-md-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-11">
                                        <select name="checker_employee_uuid" class="form-control theSelect theSelect2"
                                            ...
                                            @if(old('checker_employee_uuid', $over_burden->checker_employee_uuid ) == $employee->uuid)
                                ...
                                <div class="row">
                                    <div class="col-11">
                                        <select name="foreman_employee_uuid" class="form-control theSelect theSelect3"
                                            ...
                                            @foreach($employees as $employee)
                                            @if(old('foreman_employee_uuid', $over_burden->foreman_employee_uuid ) == $employee->uuid)
                                            <option value="{{ $employee->uuid }}" selected>{{ $employee->name }}
                                            </option>
                                            @else
                                            <option value="{{ $employee->uuid }}">{{ $employee->name }}</option>
                                ...
                                <div class="row">
                                    <div class="col-11">
                                        <select name="supervisor_employee_uuid"
                                            ...
                                            @foreach($employees as $employee)
                                            @if(old('supervisor_employee_uuid', $over_burden->supervisor_employee_uuid) ==
                                            $employee->uuid)
                                            <option value="{{ $employee->uuid }}" selected>{{ $employee->name }}
                                            </option>
                                            @else
                                ...
                                <div class="row">
                                    <div class="col-3 mr-20">
                                        <div class="custom-control custom-radio mb-5">
                                            <input type="radio" id="customRadio5" {{ ($over_burden->shift=='Siang' )? 'checked' :''
                                    ...
                                    <div class="col-5">
                                        <div class="ml-10 custom-control custom-radio mb-5">
                                            <input type="radio" id="customRadio6" {{ ($over_burden->shift=='Malam' )? 'checked' :''
                            ...
                            <div class="form-group">
                                ...
                                <div class="row">
                                    <div class="col-2 mr-10">
                                        <div class="custom-control custom-radio mb-5">
                                            <input type="radio" id="customRadio1" {{ ($over_burden->material=='OB' )? 'checked' :''
                                    ...
                                    <div class="col-3 mr-20">
                                        <div class="custom-control custom-radio mb-5">
                                            <input type="radio" id="customRadio3" {{ ($over_burden->material=='Lumpur' )? 'checked'
                                    ...
                                    <div class="col-5">
                                        <div class="ml-10 custom-control custom-radio mb-5">
                                            <input type="radio" id="customRadio2" {{ ($over_burden->material=='Top Soil' )? 'checked'
                        ...
                        <input type="hidden" name="id_note" value="{{  $over_burden->id_note}}">
                        <div class="col-12">
                            <textarea class="form-control" placeholder="Catatan" name="note" id="" cols="30"
                                rows="10">{{ $over_burden->note }}</textarea>
                        </div>
                    </div>
