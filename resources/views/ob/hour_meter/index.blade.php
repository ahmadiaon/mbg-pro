                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="card-box  pd-20">
                            ...
                            <form action="/admin-ob/add-operator" method="POST" enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="group" value="Dump Truck">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="row">
                                        <div class="col-11">
                                            <select name="operator_employee_uuid" class="form-control custom-select2"
                                                id="operator_employee_uuid1">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <div class="form-group">
                                            ...
                                            <div class="row">
                                                <div class="col-11">
                                                    <select class="form-control custom-select2" name="vehicle_uuid"
                                                        id="vehicle_uuid_2">
                                                        @foreach($vehicles as $vehicle)
                                                        <option value="{{ $vehicle->uuid }}">
                                                            {{ $vehicle->group_code }} - {{ $vehicle->number }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="">Flit</label>
                                    <div class="row">
                                        <div class="col-11">
                                            <select class="form-control selectpicker" name="over_burden_flit_uuid"
                                                id="over_burden_flit_uuid">

                                                @if($over_burden_flits->isNotEmpty())
                                                @foreach($over_burden_flits as $over_burden_flit)
                                                <option value="{{ $over_burden_flit->uuid }}">
                                                    {{ $over_burden_flit->group_code }} - {{ $over_burden_flit->number }}
                                                </option>
                                                @endforeach
                                                @else
                                                <option value="">
                                ...
                                <div class="form-group">
                                    ...
                                    <input required name="hm_start" type="text" class="form-control">
                                </div>
                                <a href="/ob/setup">
                                                ...
                                                <div class="col-11">
                                                    <select class="form-control custom-select2"
                                                        ...
                                                        <option value="{{ $excavator->uuid }}">
                                                            {{ $excavator->group_code }} - {{ $excavator->number }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                                </div>
                    ...
                    <div class="col-4">
                        <div class="card-box  pd-20">
                            ...
                            <h4 class="text-center">Add Support</h4>
                            <form action="/admin-ob/add-operator" method="POST" enctype="multipart/form-data">
                                @csrf
