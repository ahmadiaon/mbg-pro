...
@section('content')
    <div class="card-box mb-30 " >
        <div class="row pd-20">
            <div class="col-3">
                <h4 class="text-blue h4">Database Departement</h4>
            </div>
        ...
        <div class="pb-20" id="tablePrivilege">
            <table id="table-department" class="display nowrap stripe hover table" style="width:100%">
                <thead>
                    <tr>
    ...
    <div class="modal fade" id="createCoalFrom" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel"
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <form action="/database/department/store" id="form-department" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <div class="invalid-feedback" id="req-department">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" onclick="store('department')" class="btn btn-primary">
                            Save changes
                        </button>
                    </div>
                </form>
...
@section('js')
    <script>
        showDataTableAction('database/department/data', ['department','date_start','date_end'], 'department')
        function createCoalFrom(){
            $('#createCoalFrom').modal('show');
            $('#form-department')[0].reset();
        }
       function store(idForm){
            if(isRequired(['department','date_start'])    > 0){ return false; }
       ...
       function editData(uuid){
            ...
            let _url = "/database/department/show";
            // startLoading();
            $.ajax({
                url: _url,
                type: "POST",
