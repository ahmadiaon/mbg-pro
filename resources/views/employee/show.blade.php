                    ...
                    <nav aria-label="breadcrumb" role="navigation">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a href="#" onclick=" choosePage('index-employee', null);">Daftar Karyawan</a>
                            </li>
            ...
            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30">
                <div class="pd-5 card-box height-100-p">
                    ...
                    <div class="profile-social">
                        ...
                        <button onclick="showdoc()" type="button" id="show-file" class="btn" data-bgcolor="#3b5998"
                                                ...
                                                <ul>
                                                    <li>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-right">
                                                                <text class="index-employee-health_care_place">tidak
                                                                    ada</text>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                ...
                                                <ul>
                                                    <li>
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-right">
                                                                <text class="index-employee-contract_number_full">tidak
                                                                    ada</text>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-right">
                                                                <text class="index-employee-date_start_contract">tidak
                                                                    ada</text>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            ...
                                                            <div class="col text-right">
                                                                <text class="index-employee-date_end_contract">tidak
                                                                    ada</text>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                            ...
                                            <div class="pd-5 card-box">
                                                ...
                                                <div class="tab">
                                                    <ul class="nav nav-tabs" role="tablist">
                                                        ...
                                                        <li class="nav-item index-employee-mother_in_law_name-hide">
                                                            <a class="nav-link text-blue" data-toggle="tab"
                                                                href="#mother_in_law" role="tab"
                                                                aria-selected="false">Ibu Mertua</a>
                                                        </li>
                                                        <li class="nav-item index-employee-father_in_law_name-hide">
                                                            <a class="nav-link text-blue" data-toggle="tab"
                                                        ...
                                                        <div class="tab-pane fade show active" id="father"
                                                            ...
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    ...
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-father_name">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="row">
                                                        ...
                                                        <div class="tab-pane fade " id="mother" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nama</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-mother_name">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="row">
                                                        ...
                                                        <div class="tab-pane fade" id="couple" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nama</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-couple_name">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="row">
                                                        ...
                                                        <div class="tab-pane fade" id="child1" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nama</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-child1_name">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="row">
                                                        ...
                                                        <div class="tab-pane fade" id="child2" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nama</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-child2_name">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="row">
                                                        ...
                                                        <div class="tab-pane fade" id="child3" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nama</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-child3_name">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                </dl>
                                                                <dl class="row">
                                            ...
                                            <div class="pd-5 card-box">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        ...
                                                        <div class="tab-pane fade" id="smp" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    ...
                                                                    <dt class="col-sm-3">Alamat Sekolah</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-smp_place">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                    <dt class="col-sm-3">Tahun Lulus</dt>
                                                                    <dd class="col-sm-9">
                                                        ...
                                                        <div class="tab-pane fade" id="sma" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    ...
                                                                    <dt class="col-sm-3">Alamat Sekolah</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-sma_place">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                    <dt class="col-sm-3">Tahun Lulus</dt>
                                                                    <dd class="col-sm-9">
                                                        ...
                                                        <div class="tab-pane fade" id="ptn" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    ...
                                                                    <dt class="col-sm-3">Alamat Sekolah</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-ptn_place">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                    <dt class="col-sm-3">Tahun Lulus</dt>
                                                                    <dd class="col-sm-9">
                                                        ...
                                                        <div class="tab-pane fade" id="dll" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nama Sekolah</dt>
                                                                    <dd class="col-sm-9">
                                                                    ...
                                                                    <dt class="col-sm-3">Alamat Sekolah</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-dll_place">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                    <dt class="col-sm-3">Tahun Lulus</dt>
                                                                    <dd class="col-sm-9">
                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 mb-2">
                                            <div class="pd-5 card-box">
                                                ...
                                                <div class="tab">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_b" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_b1" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_b2" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_c" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_d" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_b1_umum" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-sim_b1_umum">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                    <dt class="col-sm-3">Masa Berlaku</dt>
                                                                    <dd class="col-sm-9">
                                                    ...
                                                    <div class="tab-content">
                                                        <div class="tab-pane fade" id="sim_b2_umum" role="tabpanel">
                                                            <div class="pd-10">
                                                                <dl class="row">
                                                                    <dt class="col-sm-3">Nomor Sim</dt>
                                                                    <dd class="col-sm-9">
                                                                        <text class="index-employee-sim_b2_umum">tidak
                                                                            ada</text>
                                                                    </dd>
                                                                    <dt class="col-sm-3">Masa Berlaku</dt>
                                                                    <dd class="col-sm-9">
